...
void matmulX(int8_t *A, int8_t *B, int32_t *C)
{
    ...
    for (int i = 0; i < 128; i += 8)
        ...
        {
            auto Cr0 = svld1_s32(svptrue_b32(), C + (i / 2) * 256 + (k / 2) * 4);
            auto Cr1 = svld1_s32(svptrue_b32(), C + (i / 2) * 256 + (k / 2 + 1) * 4);
            auto Cr2 = svld1_s32(svptrue_b32(), C + (i / 2) * 256 + (k / 2 + 2) * 4);
            auto Cr3 = svld1_s32(svptrue_b32(), C + (i / 2) * 256 + (k / 2 + 3) * 4);
            auto Cr4 = svld1_s32(svptrue_b32(), C + (i / 2 + 1) * 256 + (k / 2) * 4);
            auto Cr5 = svld1_s32(svptrue_b32(), C + (i / 2 + 1) * 256 + (k / 2 + 1) * 4);
            auto Cr6 = svld1_s32(svptrue_b32(), C + (i / 2 + 1) * 256 + (k / 2 + 2) * 4);
            auto Cr7 = svld1_s32(svptrue_b32(), C + (i / 2 + 1) * 256 + (k / 2 + 3) * 4);
            auto Cr8 = svld1_s32(svptrue_b32(), C + (i / 2 + 2) * 256 + (k / 2) * 4);
            auto Cr9 = svld1_s32(svptrue_b32(), C + (i / 2 + 2) * 256 + (k / 2 + 1) * 4);
            auto Cr10 = svld1_s32(svptrue_b32(), C + (i / 2 + 2) * 256 + (k / 2 + 2) * 4);
            auto Cr11 = svld1_s32(svptrue_b32(), C + (i / 2 + 2) * 256 + (k / 2 + 3) * 4);
            auto Cr12 = svld1_s32(svptrue_b32(), C + (i / 2 + 3) * 256 + (k / 2) * 4);
            auto Cr13 = svld1_s32(svptrue_b32(), C + (i / 2 + 3) * 256 + (k / 2 + 1) * 4);
            auto Cr14 = svld1_s32(svptrue_b32(), C + (i / 2 + 3) * 256 + (k / 2 + 2) * 4);
            auto Cr15 = svld1_s32(svptrue_b32(), C + (i / 2 + 3) * 256 + (k / 2 + 3) * 4);
            for (int j = 0; j < 128; j += 8)
            {
                auto ai1 = svld1_s8(svptrue_b8(), A + (j / 8) * 1024 + (i / 8) * 64);
                auto ai2 = svld1_s8(svptrue_b8(), A + (j / 8) * 1024 + (i / 8) * 64 + 16);
                auto ai3 = svld1_s8(svptrue_b8(), A + (j / 8) * 1024 + (i / 8) * 64 + 32);
                auto ai4 = svld1_s8(svptrue_b8(), A + (j / 8) * 1024 + (i / 8) * 64 + 48);
                auto bi1 = svld1_s8(svptrue_b8(), B + (j / 8) * 1024 + (k / 8) * 64);
                auto bi2 = svld1_s8(svptrue_b8(), B + (j / 8) * 1024 + (k / 8) * 64 + 16);
                auto bi3 = svld1_s8(svptrue_b8(), B + (j / 8) * 1024 + (k / 8) * 64 + 32);
                auto bi4 = svld1_s8(svptrue_b8(), B + (j / 8) * 1024 + (k / 8) * 64 + 48);
            ...
            svst1_s32(svptrue_b32(), C + (i / 2) * 256 + (k / 2) * 4, Cr0);
            svst1_s32(svptrue_b32(), C + (i / 2) * 256 + (k / 2 + 1) * 4, Cr1);
            svst1_s32(svptrue_b32(), C + (i / 2) * 256 + (k / 2 + 2) * 4, Cr2);
            svst1_s32(svptrue_b32(), C + (i / 2) * 256 + (k / 2 + 3) * 4, Cr3);
            svst1_s32(svptrue_b32(), C + (i / 2 + 1) * 256 + (k / 2) * 4, Cr4);
            svst1_s32(svptrue_b32(), C + (i / 2 + 1) * 256 + (k / 2 + 1) * 4, Cr5);
            svst1_s32(svptrue_b32(), C + (i / 2 + 1) * 256 + (k / 2 + 2) * 4, Cr6);
            svst1_s32(svptrue_b32(), C + (i / 2 + 1) * 256 + (k / 2 + 3) * 4, Cr7);
            svst1_s32(svptrue_b32(), C + (i / 2 + 2) * 256 + (k / 2) * 4, Cr8);
            svst1_s32(svptrue_b32(), C + (i / 2 + 2) * 256 + (k / 2 + 1) * 4, Cr9);
            svst1_s32(svptrue_b32(), C + (i / 2 + 2) * 256 + (k / 2 + 2) * 4, Cr10);
            svst1_s32(svptrue_b32(), C + (i / 2 + 2) * 256 + (k / 2 + 3) * 4, Cr11);
            svst1_s32(svptrue_b32(), C + (i / 2 + 3) * 256 + (k / 2) * 4, Cr12);
            svst1_s32(svptrue_b32(), C + (i / 2 + 3) * 256 + (k / 2 + 1) * 4, Cr13);
            svst1_s32(svptrue_b32(), C + (i / 2 + 3) * 256 + (k / 2 + 2) * 4, Cr14);
            svst1_s32(svptrue_b32(), C + (i / 2 + 3) * 256 + (k / 2 + 3) * 4, Cr15);
        }
}
    ...
    if (N == 128)
    {
        ...
        for (int i = 0; i < 128; i += 2)
            for (int j = 0; j < 128; j += 8)
                for (int k = 0; k < 2; k++)
                    for (int t = 0; t < 8; t++)
                        dest[(j / 8) * 1024 + (i / 2) * 16 + k * 8 + t] = src[(tl + i + k) * NX + tr + j + t];
    }
    else
    {
    ...
    if (N == 128)
    {
        ...
        for (int i = 0; i < 128; i += 8)
            for (int j = 0; j < 128; j += 2)
                for (int k = 0; k < 8; k++)
                    for (int t = 0; t < 2; t++)
                        dest[(i / 8) * 1024 + (j / 2) * 16 + t * 8 + k] = src[(tl + i + k) * NX + tr + j + t];
    }
    else
    {
    ...
    if (N == 128)
    {
        ...
        for (int i = 0; i < 128; i += 2)
            for (int j = 0; j < 128; j += 2)
                for (int k = 0; k < 2; k++)
                    for (int t = 0; t < 2; t++)
                        dest[(tl + i + k) * NX + tr + j + t] = src[(i / 2) * 256 + (j / 2) * 4 + k * 2 + t];
    }
    else
    {
...
template <int NX> void verif()
{
    ...
    for (int i = 0; i < 128; i++)
        for (int j = 0; j < 128; j++)
            for (int k = 0; k < 128; k++)
                D[i * 128 + k] += (short)(A_test[i * 128 + j]) * B_test[j * 128 + k];
    auto aa = clock();
    repackA<NX, NX>(tmp1, A_test, 0, 0);
    repackB<NX, NX>(tmp2, B_test, 0, 0);
    auto a = clock();

...
This is an example test of VNNI for int8 calculations. The matrix size is 24576x24576 and OpenMP is used (6 threads), giving each thread a 4096x24576x24576 multiplication.
